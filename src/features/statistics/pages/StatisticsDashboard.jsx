...
import { LatestReadingCard } from '../components/LatestReadingStatistics';  
...
export default function StatisticsDashboard() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-white">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm">Fetching water quality data</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 p-6 bg-white min-h-screen">
      ...
      {/* Live Monitoring Section - Using QualityMetricsCards component */}
      <div>
        <h2 className="text-xl font-semibold text-white mb-4">Live Monitoring</h2>
        <p className="text-blue-400 text-sm mb-4">Real-time data from IoT Sensor Node</p>
        <QualityMetricsCards 
      ...
      {/* Latest Reading Card - Using LatestReadingCard component */}
      {latestReading && (
        <LatestReadingCard latestReading={latestReading} />
      )}

      {/* Range Statistics - Using RangeStatistics component */}
      <RangeStatistics 
        dashboardStats={dashboardData}
        minMaxStats={minMaxData}
      />

      {/* Stability Statistics - Using StabilityStatistics component */}
      <StabilityStatistics 
        dashboardStats={dashboardData}
        stdDevStats={null}
      />

      {/* Water Quality Classification Distribution - Using ClassificationDistribution component */}
