...
import StatisticsDashboardPage from '@/features/statistics/pages/StatisticsDashboard'
    ...
    children: [
      { 
        ...
        children: [
              ...
              { path: 'stats', element: <StatisticsDashboardPage />, allowedRoles: ['officer','admin','superadmin'] },
